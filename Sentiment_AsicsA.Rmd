...
Скачиваем данные
```{r}
asics <- read.csv("/Users/polina/Desktop/2 MMA/Term paper/За 5 недель/dataAsicsA.csv", sep=",")
```
...
Выбираем только те слова, которые повторяются больше 50 раз
```{r}
...
ggsave('asics_bing.png', units = 'in', dpi = 400)
```
#NRC
...
ggsave('asics_nrc.png', units = 'in', dpi = 400, scale = 1.2)
```
